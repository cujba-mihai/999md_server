...
export abstract class IMutation {
    ...
    abstract createCategories(createCategoriesInput: CreateCategoriesInput): Category[] | Promise<Category[]>;

    abstract createCategory(category: CreateCategoryDTO): Category | Promise<Category>;
    ...
    abstract removeSubcategory(id: GetOneSubcategoryDTO): Subcategory | Promise<Subcategory>;
...
export abstract class IQuery {
    ...
    abstract findByRelation(filter: GetSubcategoryByRelationDTO): SubcategoriesDTO | Promise<SubcategoriesDTO>;
    ...
    abstract getCategoryByName(categoryName: string): Category | Promise<Category>;

    abstract getCategoryByNameAndSubcategory(categoryName: string, subcategoryName: string): Category | Promise<Category>;

    abstract getProducts(): GetProductsDTO[] | Promise<GetProductsDTO[]>;

    abstract getProductsByCategory(listProductByCategoryInput: ListProductsByCategoryDTO): GetProductsDTO[] | Promise<GetProductsDTO[]>;

    abstract getProductsBySubcategory(listProductByCategoryInput: ListProductsBySubcategoryDTO): GetProductsDTO[] | Promise<GetProductsDTO[]>;
    ...
    abstract subcategory(subcategoryId: GetOneSubcategoryDTO): SubcategoriesDTO | Promise<SubcategoriesDTO>;
